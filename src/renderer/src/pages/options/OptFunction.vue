...
<template>
    <div class="opt-page">
        <div class="ss-card">
            ...
            <div class="opt-item">
                <div :class="checkDefalut('close_notice')" />
            ...
            <div class="opt-item">
                <div :class="checkDefalut('bubble_sort_user')" />
            ...
            <div v-if="!runtimeData.sysConfig.bubble_sort_user" class="opt-item">
                <div :class="checkDefalut('group_notice_type')" />
        ...
        <div class="ss-card">
            ...
            <div class="opt-item">
                <div :class="checkDefalut('close_chat_pic_pan')" />
            ...
            <div class="opt-item">
                <div :class="checkDefalut('close_respond')" />
            ...
            <div class="opt-item">
                <div :class="checkDefalut('msg_taill')" />
            ...
            <div class="opt-item">
                <div :class="checkDefalut('quick_send')" />
            ...
            <div class="opt-item">
                <div :class="checkDefalut('send_face')" />
            ...
            <div class="opt-item">
                <div :class="checkDefalut('use_breakline')" />
        ...
        <div class="ss-card">
            <header>{{ $t('浏览') }}</header>
            <div class="opt-item">
                <div :class="checkDefalut('close_browser')" />
        ...
        <div class="ss-card">
            ...
            <div
                ...
                <div :class="checkDefalut('close_ga')" />
            ...
            <div v-if="runtimeData.sysConfig.close_ga !== true"
                class="opt-item">
                <div :class="checkDefalut('open_ga_bot')" />
...
<script lang="ts">
    ...
    import { runASWEvent as save, optDefault } from '@renderer/function/option'
